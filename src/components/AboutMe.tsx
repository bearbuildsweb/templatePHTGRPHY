...
export default function AboutMe({ onBioModalToggle }: AboutMeProps) {
  ...
  return (
    <section 
      id="about" 
      className="relative w-full bg-[#E5E7EA] text-[#111929] py-20 sm:py-28 md:py-36 px-6 sm:px-10 md:px-16 overflow-hidden border-t border-[#111929]/20 selection:bg-[#111929] selection:text-[#E5E7EA]"
    >
      <div className="max-w-xl mx-auto">
        
        {/* Top Minimalist Header Tag & Hairline */}
        <div className="w-full mb-8 sm:mb-12">
          <span className="block font-sans text-xs sm:text-sm tracking-tight text-[#111929]/80 font-bold mb-2 uppercase">
            EKO PHTGRPHY
          </span>
          <div className="w-full h-[1px] bg-[#111929]/20" />
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative mb-6 sm:mb-8">
            <div className="flex items-start">
              <span className="font-sans font-bold text-sm sm:text-base md:text-lg text-[#111929] tracking-tight mr-4 sm:mr-6 pt-2 shrink-0">
                about EKO
              </span>
              ...
              >
                <div className="w-36 h-40 sm:w-48 sm:h-52 md:w-56 md:h-60 overflow-hidden rounded-[38%_62%_58%_42%/42%_46%_54%_58%] shadow-[0_12px_32px_rgba(17,25,41,0.25)] bg-[#111929] border-2 border-[#111929]/40 transition-transform duration-500 group-hover:scale-[1.02]">
                  <img
                    src={bioPortrait}
                    alt="eko PHTGRPHY"
          ...
          <div className="relative pt-2">
            ...
            <div 
              className="absolute right-[-20px] sm:right-[-40px] md:right-[-60px] top-[40%] -translate-y-1/2 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full border border-[#111929]/20 pointer-events-none z-0"
              aria-hidden="true"
            />
            ...
            >
              <h2 className="font-sans text-4xl sm:text-6xl md:text-7xl font-bold text-[#111929] tracking-tight leading-[1.08] mb-8 sm:mb-10">
                Places, people<br />
                & passing<br />
                moments
              </h2>
            ...
            >
              ...
              <div className="p-[3px] rounded-full bg-[#111929]/10 shadow-[0_6px_20px_rgba(17,25,41,0.15)] border-t border-[#111929]/20 border-b border-[#111929]/35">
                <button
                  type="button"
                  onClick={() => setIsBioModalOpen(true)}
                  aria-label="Read full biography and artist dossier"
                  className="group relative inline-flex items-center gap-2.5 px-7 py-3 sm:px-8 sm:py-3.5 rounded-full bg-[#111929] hover:bg-[#1A253C] shadow-[0_4px_16px_rgba(17,25,41,0.3)] border-t border-white/10 border-b border-black/40 transition-all duration-300 active:scale-[0.98] cursor-pointer"
                >
        ...
        {isBioModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#111929] text-white rounded-2xl sm:rounded-3xl shadow-[0_25px_70px_rgba(0,0,0,0.8)] border border-[#C5A059]/40 overflow-hidden z-10 max-h-[90vh] flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Modal Top Nav Bar */}
              <div className="flex items-center justify-between px-6 py-4 sm:px-8 sm:py-5 border-b border-[#C5A059]/20 bg-[#162134] backdrop-blur-sm shrink-0">
              ...
              <div className="overflow-y-auto px-6 py-6 sm:px-10 sm:py-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 pb-6 border-b border-[#C5A059]/20">
                  <div className="w-28 h-32 sm:w-32 sm:h-36 shrink-0 overflow-hidden rounded-[40%_60%_55%_45%/45%_50%_50%_55%] shadow-md bg-[#111929] border-2 border-[#C5A059]/40">
                    <img
                      src={bioPortrait}
                      alt="eko PHTGRPHY"
              ...
              <div className="flex items-center justify-between gap-3 px-6 py-4 sm:px-10 sm:py-5 border-t border-[#C5A059]/20 bg-[#162134] backdrop-blur-sm shrink-0">
                ...
                <div className="p-[3px] rounded-full bg-[#121927] shadow-[inset_0_3px_8px_rgba(0,0,0,0.6),inset_0_-1px_1px_rgba(255,255,255,0.1)] border-t border-[#C5A059]/30 border-b border-black">
                  <a
                    ...
                    title="Instagram"
                    className="group relative inline-flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#111929] hover:bg-[#1A253C] shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] border-t border-black/40 border-b border-white/20 text-[#C5A059] hover:text-white transition-all duration-300 active:scale-[0.96] cursor-pointer"
                  >
